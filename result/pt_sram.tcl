...
## Setting files/paths
set verilog_files {../../dc/sram/sram.nl.v}
set my_toplevel sram
set link_library "../../dc/mem/memory_tt_1p2v_25c_syn.db"
set search_path ". /courses/ee6321/share/ibm13rflpvt/synopsys/"
set link_path "* scx3_cmos8rf_lpvt_tt_1p2v_25c.db" 

## Read design
read_db "../../dc/mem/memory_tt_1p2v_25c_syn.db"
...
read_vcd "../../qsim_dc/sram/sram.vcd" -strip_path "testbench/u0"
...
write_sdf -context verilog "./sram.sdf"
